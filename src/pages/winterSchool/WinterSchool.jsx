        ...
        <div className="winterSchoolIntro">
          ...
          <div className="winterSchoolIntroContent">
            <p>
              ...
              courses required in the programming field.
              <br></br>- Data structures and algorithms
              <br></br>- Web development
              <br></br>- Git and GitHub
              <br></br>
              <br></br>
              Winter School aims to provide a more profound and in-depth
              understanding of these topics. The subject undertaken will be
              taught by experienced and qualified mentors. The schedule of this
              course starts on 21st December and ends on 30th December 2022.
              <br></br>
              <br></br>
              The key aspects that make Winter School stand out from other
              available courses are:
              <br></br>- 1-1 doubt sessions
              <br></br>- Practical problems implementation
              <br></br>- Certificate by GDSC
              <br></br>- Potential internship counseling
              <br></br>
              <br></br>
              Renowned professionals will join the course and share their
        ...
        <div className="courseFacilitatorsWrapper">
          ...
          <div className="courseFacilitatorsContainer">
            <Member
              memberImage={ritvik}
              memberName={"Ritvik G."}
              memberPosition={"GDSC Lead"}
            />
            <Member
              memberImage={rajakarthik}
              memberName={"Vobugari Raja Karthik"}
              memberPosition={"Senior Web Developer"}
            />
            <Member
              memberImage={mamoor}
              memberName={"Mammor Jaan Khan"}
              memberPosition={"Senior Web Developer"}
            />
          </div>
        </div>
